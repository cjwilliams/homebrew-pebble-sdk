...
class PebbleSdk < Formula
  ...
  sha256 "330a11daa7b7368f2878a4b8dfe7bf8129d0321f8739193e900bd9b082a2cfbe"
  ...
  resource 'autobahn' do
    ...
    sha1 'd56979d4dffae6dc4d9c840629b9a8092ac41ea75f55052d70943edf7e01979d'
  end

  resource 'backports.ssl-match-hostname' do
    url 'https://pypi.python.org/packages/source/b/backports.ssl_match_hostname/backports.ssl_match_hostname-3.4.0.2.tar.gz'
    sha1 '07410e7fb09aab7bdaf5e618de66c3dac84e2e3d628352814dc4c37de321d6ae'
  end

  resource 'freetype-py' do
    url 'https://pypi.python.org/packages/source/f/freetype-py/freetype-py-1.0.tar.gz'
    sha1 '1fc67817d5fb9f1329a1a431850a46f01f250a1d6380e4bcecdb54266023e99a'
  end

  resource 'gevent' do
    url 'https://pypi.python.org/packages/source/g/gevent/gevent-1.0.2.tar.gz'
    sha1 '3ae1ca0f533ddcb17aab16ce66b424b3f3b855ff3b9508526915d3c6b73fba31'
  end

  resource 'gevent-websocket' do
    url 'https://pypi.python.org/packages/source/g/gevent-websocket/gevent-websocket-0.9.3.tar.gz'
    sha1 '6475220340f9f8895a0f51bd2b9df3511bc7765dc055f49e997584bdaee3381f'
  end

  resource 'greenlet' do
    url 'https://pypi.python.org/packages/source/g/greenlet/greenlet-0.4.7.zip'
    sha1 'f32c4fa4e06443e1bdb0d32b69e7617c25ff772c3ffc6d0aa63d192e9fd795fe'
  end

  resource 'oauth2client' do
    url 'https://pypi.python.org/packages/source/o/oauth2client/oauth2client-1.3.tar.gz'
    sha1 '668ffe5a9a6df1f5fca50a851da9ce97286dc10f190b05e84763a8cd9716141b'
  end

  resource 'peewee' do
    url 'https://pypi.python.org/packages/source/p/peewee/peewee-2.4.7.tar.gz'
    sha1 '8ad1c4fb202332a969da83a0af712bca96ed6e2a70ca1523ab3d2a2234ed47bd'
  end

  resource 'pygeoip' do
    url 'https://pypi.python.org/packages/source/p/pygeoip/pygeoip-0.3.2.tar.gz'
    sha1 'f22c4e00ddf1213e0fae36dc60b46ee7c25a6339941ec1a975539014c1f9a96d'
  end

  resource 'pypng' do
    url 'https://pypi.python.org/packages/source/p/pypng/pypng-0.0.17.tar.gz'
    sha1 '2dfa74ac28a4c41ae61e62d243410548c7c174bd990528d30270324f15211544'
  end

  resource 'pyserial' do
    url 'https://pypi.python.org/packages/source/p/pyserial/pyserial-2.6.tar.gz'
    sha1 '049dbcda0cd475d3be903e721d60889ee2cc4ec3b62892a81ecef144196413ed'
  end

  resource 'python-dateutil' do
    url 'https://pypi.python.org/packages/source/p/python-dateutil/python-dateutil-2.4.1.post1.tar.gz'
    sha1 'aa9bdbd60c395db90204609f1fb5aeb3797870f65c09f04f243476d22f8f4615'
  end

  resource 'requests' do
    url 'https://pypi.python.org/packages/source/r/requests/requests-2.7.0.tar.gz'
    sha1 '398a3db6d61899d25fd4a06c6ca12051b0ce171d705decd7ed5511517b4bb93d'
  end

  resource 'sh' do
    url 'https://pypi.python.org/packages/source/s/sh/sh-1.09.tar.gz'
    sha1 'f3d174e2ad25c39f28935bae672be51aa083063d3122405ceeb2a3e7a8239d45'
  end

  resource 'six' do
    url 'https://pypi.python.org/packages/source/s/six/six-1.8.0.tar.gz'
    sha1 '047bbbba41bac37c444c75ddfdf0573dd6e2f1fbd824e6247bb26fa7d8fa3830'
  end

  resource 'twisted' do
    url 'https://pypi.python.org/packages/source/T/Twisted/Twisted-12.0.0.tar.bz2'
    sha1 'e5561c9714583fd052ea9e0b10331609a719b3878f9d2593e4c57eab0ba0effd'
  end

  resource 'websocket-client' do
    url 'https://pypi.python.org/packages/source/w/websocket-client/websocket-client-0.22.0.tar.gz'
    sha1 '83a173ea32ef4209a1933b3e0f5bfafe533b909073ff8d657f044b5792b8c7b5'
  end

  resource 'wsgiref' do
    url 'https://pypi.python.org/packages/source/w/wsgiref/wsgiref-0.1.2.zip'
    sha1 'c7e610c800957046c04c8014aab8cce8f0b9f0495c8cd349e57c1f7cabf40e79'
  end
